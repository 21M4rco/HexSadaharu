...
public final class Personality {
    ...
    private void goHome(ServerPlayer owner) {
        ...
        if(dog.act().resting()||dog.act()==Act.HEAD_BITE){dog.setAct(Act.NONE);dog.gagTarget(-1);}
