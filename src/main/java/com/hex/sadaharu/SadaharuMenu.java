...
public final class SadaharuMenu extends AbstractContainerMenu {
    ...
    @Override public boolean clickMenuButton(Player p,int button) {
        ...
        switch(button){case 0->{dog.home=dog.blockPosition();dog.homeDimension=dog.level().dimension();}case 1->dog.home=null;case 2->dog.automaticHome=!dog.automaticHome;
            case 5->{
                dog.following=!dog.following;
                // Following again overrides an earlier "go home and stay there".
